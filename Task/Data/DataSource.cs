...
namespace Task.Data
{
    public class DataSource
    {
        ...
        public List<Customer> Customers
        {
            get
            {
                if (this.customerList == null) this.createLists();
        ...
        public List<Product> Products
        {
            get
            {
                if (this.productList == null) this.createLists();
        ...
        public List<Supplier> Suppliers
        {
            get
            {
                if (this.supplierList == null) this.createLists();
        ...
        private void createLists()
        {
            ...
            this.customerList = (from e in XDocument.Parse(Properties.Resources.Customers).Root.Elements("customer")
                                 select new Customer
                                            {
